...
import { Loader2, QrCode, Mail, Lock, User, ChevronDown, ChevronUp, CheckCircle2 } from "lucide-react"
...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Still use legacy register API for password-based signup
      ...
      // After registration, sign in via credentials
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background to-muted/20 p-4">
        <Card className="w-full max-w-md">
          ...
          <CardContent className="space-y-4">
            <Alert>
              <AlertDescription>
                Click the link in your email to create your account and get <strong>100 FREE QR credits</strong>!
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background to-muted/20 p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardDescription>
            Sign up to get <strong>100 FREE QR credits</strong> instantly!
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          {error && (
          ...
          {/* Legacy Password Registration (Collapsible) */}
          <div>
            <button
              type="button"
