...
export const USD_TO_MYR = 4.50 // Update this rate as needed
...
// Convert USD price to MYR
export const convertToMYR = (usdPrice: number): number => {
  return Math.round(usdPrice * USD_TO_MYR * 100) / 100
}
